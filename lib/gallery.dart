...
class _GalleryScreenState extends State<GalleryScreen> {
  ...
  // Fetch gallery data from the new API
  Future<void> fetchGalleryData() async {
    final response = await http.get(Uri.parse('https://causal-monkey-reasonably.ngrok-free.app/api/galeries'));
  ...
  // Fetch photos for a specific gallery from the new API
  Future<void> fetchPhotos(int galleryId) async {
    final response = await http.get(Uri.parse('https://causal-monkey-reasonably.ngrok-free.app/api/photos'));
  ...
  Widget _buildPhotosView() {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        String imageUrl = 'https://causal-monkey-reasonably.ngrok-free.app/storage/${photo['isi_foto']}';
