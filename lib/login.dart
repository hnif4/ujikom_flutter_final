...
class LoginScreen extends StatelessWidget {
  ...
  // Function to perform login through the API
  Future<void> _login(BuildContext context) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://causal-monkey-reasonably.ngrok-free.app/api/login/admin'), // Updated API endpoint
